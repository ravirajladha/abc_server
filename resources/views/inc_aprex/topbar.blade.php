<div class="middle-sidebar-header bg-white">
                ...
                <ul class="d-flex ml-auto right-menu-icon">
                    ...
                    <li><a href=""><img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 rounded-circle mt--1"></a></li>
                    <li><a href="/aprex/default_user_profile" class="menu-search-icon"><i class="feather-user text-grey-900 font-lg"></i></a></li>
                </ul>
            </div>