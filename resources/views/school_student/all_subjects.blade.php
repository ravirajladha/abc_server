<?php session()->put('curnav','subject'); ?>
@include("inc.header")
@php
                ...
                <div class="middle-sidebar-left">
                    <div class="row">
                        <div class="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
                            <div>
                                <h2 class="fw-400 font-lg d-block">My <b> Subjects</b> </h2>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                ...
                                <a href="/subject_live_stream/{{$subject->id}}/0" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current">LEARN</a>

                                @if(!empty($tests[$index] !== null))
                                <a href="/take_school_test/{{$subject->id}}/{{$tests[$index]->id}}" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current">TAKE TEST</a>
                                @else
