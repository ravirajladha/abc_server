<?php session()->put('curnav','school_forums'); ?>
@include('inc.header')
<style>
    .result {
        max-height: 200px;
            ...
            <div class="middle-sidebar-bottom bg-lightblue theme-dark-bg">
                <div class="middle-sidebar-left">
                    ...
                    <div class="card-body p-4 w-100 border-0 d-flex rounded-lg">
                        <h2 class="fw-400 font-lg d-block">ABC<b> Forum</b> </h2>
                    </div>
                    ...
                    <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                        ...
                        <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                            ...
                            <form action="/school_create_forum" method="post" enctype="multipart/form-data">
                                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.search-box input[type="text"]').on("keyup input", function() {
                ...
                var resultDropdown = $(".result");
                if (inputVal.length) {
                    $.get("/school_search_forum_questions", {
                        term: inputVal
                    }).done(function(data) {
            ...
            $(document).on("click", ".result p", function() {
                ...
                var searchButtonUrl = "/view_school_forum/" + resultId;
