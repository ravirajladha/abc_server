                ...
                <div class="middle-sidebar-left">
                    <div class="row">
                        <div class="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
                            <div>
                                <h2 class="fw-400 font-lg d-block">All <b>Project Report Modules</b> </h2>
                            </div>
                        ...
                        <div id="accordion" class="accordion mb-0">
                            @foreach ($data['project_report_modules'] as $modules)
                                    ...
                                    <div class="card-header bg-greylight theme-dark-bg"
                                        ...
                                        <h5 class="mb-0">
                                            <button class="btn font-xsss fw-600 btn-link "
                                                ...
                                                <a href="/admin/add_project_report_elements/{{ $modules->id }}" class="p-2 text-white fw-700 rounded-lg text-center font-xsssss bg-current float-right mr-3"><i class="far fa-edit"></i></a>
                                        </h5>
                                    </div>
