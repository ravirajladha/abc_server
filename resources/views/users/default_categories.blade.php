        ...
        <nav class="navigation scroll-bar">
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    <div class="nav-top">
                        <a href="index.html"><i class="feather-slack text-success display1-size mr-3 ml-3"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xl logo-text mb-0">ABC </span> </a>
                    ...
                    <ul class="mb-3">
                        ...
                        <li><a href="default.html" class="active nav-content-bttn open-font" data-tab="chats"><i class="feather-tv mr-3"></i><span>Course Feed</span></a></li>
                        <li><a href="default-follower.html" class="nav-content-bttn open-font" data-tab="friends"><i class="feather-shopping-bag mr-3"></i><span>Followers</span></a></li>
                        <li><a href="default-channel.html" class="nav-content-bttn open-font" data-tab="favorites"><i class="feather-globe mr-3"></i><span>Explore Channel</span></a></li>
                        <li><a href="default-live-stream.html" class="nav-content-bttn open-font" data-tab="favorites"><i class="feather-play-circle mr-3"></i><span>Live Stream</span></a></li>
                        <li class="flex-lg-brackets"><a href="default-user-profile.html" data-tab="archived" class="nav-content-bttn open-font"><i class="feather-video mr-3"></i><span>Saved Course</span></a></li>
                    </ul>

                    <div class="nav-caption fw-600 font-xssss text-grey-500"><span>Following </span>Author</div>
                    <ul class="mb-3">
                        <li><a href="default-author-profile.html" class="nav-content-bttn open-font pl-2 pb-2 pt-1 h-auto" data-tab="chats"><img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 mr-2 rounded-circle"><span>Surfiya Zakir </span> <span class="circle-icon bg-success mt-3"></span></a></li>
                        <li><a href="default-author-profile.html" class="nav-content-bttn open-font pl-2 pb-2 pt-1 h-auto" data-tab="chats"><img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 mr-2 rounded-circle"><span>Vincent Parks </span> <span class="circle-icon bg-warning mt-3"></span></a></li>
                        <li><a href="default-author-profile.html" class="nav-content-bttn open-font pl-2 pb-2 pt-1 h-auto" data-tab="chats"><img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 mr-2 rounded-circle"><span>Richard Bowers </span> <span class="circle-icon bg-success mt-3"></span></a></li>
                        <li><a href="default-author-profile.html" class="nav-content-bttn open-font pl-2 pb-2 pt-1 h-auto" data-tab="chats"><img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 mr-2 rounded-circle"><span>John Lambert </span> <span class="circle-icon bg-success mt-3"></span></a></li>
                    </ul>
                ...
                <div class="middle-sidebar-left">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-0">
                            <div class="owl-carousel course-slide owl-theme overflow-hidden dot-style2 owl-nav-link ">
                                <div class="item">
                                    <div class="card course-slider rounded-lg border-0 banner-wrap overflow-hidden">
                                        <div class="video-wrap">
                                            <img src="https://via.placeholder.com/1200x600.png" alt="image">
                                        </div>
                                        <div class="card-body position-absolute align-items-center d-flex h-100">
                                            <div class="card-content">
                                                <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-lg ls-2 alert-warning d-inline-block text-warning mr-1 mb-2">React</span>
                                                <h2 class="display1-size display1-sm-size fw-700 lh-3 text-white ">The Complete Guide React Vue Developer</b></h2>
                                                <p class="d-none d-xl-block font-xssss fw-500 text-grey-300 lh-30 mt-0 mr-5 mb-0">ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                ...
                                                <p class="review-link d-none d-lg-block font-xssss fw-600 text-grey-100 lh-3 mb-1">(456 ratings ) 2 customer review</p>
                                                <div class="clearfix"></div>
                                                <a href="#" class="bg-primary-gradiant border-0 text-white fw-600 text-uppercase font-xssss float-left rounded-lg d-inline-block mt-0 p-2 lh-34 text-center ls-3 w200 mt-3">Get Course</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="card course-slider rounded-lg border-0 banner-wrap overflow-hidden">
                                        ...
                                        <div class="card-body position-absolute align-items-center d-flex h-100">
                                            <div class="card-content">
                                                <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-lg ls-2 alert-warning d-inline-block text-warning mr-1 mb-2">React</span>
                                                <h2 class="display1-size display1-sm-size fw-700 lh-3 text-white ">Complete Python Bootcamp From Zero </b></h2>
                                                <p class="d-none d-xl-block font-xssss fw-500 text-grey-300 lh-30 mt-0 mr-5 mb-0">ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <div class="star d-block w-100 text-left mt-2">
                                                    <img src="images/star.png" alt="star" class="w15 float-left">
                                                    <img src="images/star.png" alt="star" class="w15 float-left">
                                ...
                                <div class="item">
                                    <div class="card course-slider rounded-lg border-0 banner-wrap overflow-hidden">
                                        ...
                                        <div class="card-body position-absolute align-items-center d-flex h-100">
                                            <div class="card-content">
                                                <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-lg ls-2 alert-warning d-inline-block text-warning mr-1 mb-2">React</span>
                                                <h2 class="display1-size display1-sm-size fw-700 lh-3 text-white ">Design and Advanced Methods Workshop Tutorial </b></h2>
                                                <p class="d-none d-xl-block font-xssss fw-500 text-grey-300 lh-30 mt-0 mr-5 mb-0">ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                                                <div class="star d-block w-100 text-left mt-2">
                                                    <img src="images/star.png" alt="star" class="w15 float-left">
                                                    <img src="images/star.png" alt="star" class="w15 float-left">
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="default-course-details.html" class="text-dark text-grey-900">Java Programming Masterclass for Developers</a></h4>
                            ...
                            <div class="owl-carousel category-card owl-theme overflow-hidden overflow-visible-xl nav-none">
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="default-course-details.html" class="text-dark text-grey-900">Fundamentals for Scrum Master and Agile Projects </a></h4>
                                            <h6 class="font-xssss text-grey-500 fw-600 ml-0 mt-2"> 32 Lesson </h6>
                                            <ul class="memberlist mt-3 mb-2 ml-0 d-block">
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-lg ls-2 alert-primary d-inline-block text-primary mr-1">Bootstrap</span>
                                            <span class="font-xss fw-700 pl-3 pr-3 ls-2 lh-32 d-inline-block text-success float-right"><span class="font-xsssss">$</span> 760</span>
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="default-course-details.html" class="text-dark text-grey-900">Automate the Boring Stuff with Python Programming</a></h4>
                                            <h6 class="font-xssss text-grey-500 fw-600 ml-0 mt-2"> 14 Lesson </h6>
                                            <ul class="memberlist mt-3 mb-2 ml-0 d-block">
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                        ...
                        <div class="col-lg-12 pt-0 mb-3">
                            <h2 class="fw-400 font-lg d-block">Live <b> Classes</b> <a href="#" class="float-right" ><i class="feather-edit text-grey-500 font-xs"></i></a></h2>
                        </div>
