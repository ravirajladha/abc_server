                                        ...
                                        <div class=" text-center">
                                            <form method="post" action="/apply_internship">
                                                ...
                                                <div class=" mt-3 text-center">
                                                    @if ($application)
                                                    <a href="/view_internship/{{$internship->id}}" class="btn bg-current text-center text-white font-xsss fw-600 p-2 w175 rounded-lg d-inline-block border-0" disabled>View</a>
                                                    @else
