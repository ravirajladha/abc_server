                        ...
                        <div class="col-xxl-12 col-xl-12 col-md-12">
                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-5 border-0 text-left question-div">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($assesments_result as $assessment)
                                        @php


                                        @endphp
                                        <tr>
                                            <td scope="row">{{$assessment->video_name }}</td>
                                            <td>{{date('Y-m-d', strtotime($assessment->created_at))}}</td>
                                            <td>{{date('H:i:s', strtotime($assessment->created_at))}}</td>
                                            <td scope="row">{{$assessment->score}}</td>
