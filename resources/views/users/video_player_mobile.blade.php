    ...
    <script>
                    ...
                    `<li class="video " data-id="${section_videos[i].id}">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between" style="width: 100%;margin-left: 2rem;">
                                ...
                                <div style="border: 1px solid #b8afaf;padding: 0 8px;"><a class="font-xssss" href="${section_videos[i].digital_link}" target="_blank">Digital Book</a></div>
        ...
        videos.forEach(selected_video => {
            ...
            selected_video.onclick = () => {
                ...
                window.location.href = '/default_live_stream/{{$data['course']->id}}/0/'+ videoId;
            }
        });
    </script>
</body>
