                ...
                <div class="middle-sidebar-left">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <div class="card rounded-xxl p-lg--5 border-0 bg-no-repeat bg-image-contain banner-wrap" style="background-image: url(https://via.placeholder.com/1100x720.png);;">
                        ...
                        <div class="col-lg-12 pt-2">
                            <h2 class="fw-400 font-lg">Explore <b>Categories</b> <a href="#" class="float-right" ><i class="feather-edit text-grey-500 font-xs"></i></a></h2>
                        </div>
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="owl-carousel category-card owl-theme overflow-hidden overflow-visible-xl nav-none">
                                <div class="item">
                                    <div class="card cat-card-hover mr-1 w140 border-0 p-4 rounded-lg text-center" style="background-color: #fcf1eb;">
                                        <div class="card-body p-2 ml-1 ">
                                            <a href="#" class="btn-round-xl bg-white"><img src="https://via.placeholder.com/50x50.png" alt="icon" class="p-2"></a>
                                ...
                                <div class="item">
                                    <div class="card cat-card-hover mr-1 w140 border-0 p-4 rounded-lg text-center" style="background-color: #fff9eb;">
                                        <div class="card-body p-2 ml-1 ">
                                            <a href="#" class="btn-round-xl bg-white"><img src="https://via.placeholder.com/50x50.png" alt="icon" class="p-2"></a>
                                ...
                                <div class="item">
                                    <div class="card cat-card-hover mr-1 w140 border-0 p-4 rounded-lg text-center" style="background-color: #e5f4fb;">
                                        <div class="card-body p-2 ml-1 ">
                                            <a href="#" class="btn-round-xl bg-white"><img src="https://via.placeholder.com/50x50.png" alt="icon" class="p-2"></a>
                                ...
                                <div class="item">
                                    <div class="card cat-card-hover mr-1 w140 border-0 p-4 rounded-lg text-center" style="background-color: #dcf4f8;">
                                        <div class="card-body p-2 ml-1 ">
                                            <a href="#" class="btn-round-xl bg-white"><img src="https://via.placeholder.com/50x50.png" alt="icon" class="p-2"></a>
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="default_course_details" class="text-dark text-grey-900">Fundamentals for Scrum Master and Agile Projects </a></h4>
                                            <h6 class="font-xssss text-grey-500 fw-600 ml-0 mt-2"> 32 Lesson </h6>
                                            <ul class="memberlist mt-3 mb-2 ml-0 d-block">
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                ...
                                <div class="item">
                                    <div class="card course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="default_course_details" class="text-dark text-grey-900">Automate the Boring Stuff with Python Programming</a></h4>
                                            <h6 class="font-xssss text-grey-500 fw-600 ml-0 mt-2"> 14 Lesson </h6>
                                            <ul class="memberlist mt-3 mb-2 ml-0 d-block">
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
                                                <li><a href="#"><img src="https://via.placeholder.com/30x30.png" alt="user" class="w30 d-inline-block"></a></li>
