                ...
                <div class="card shadow-none border-0 ml-auto mr-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form action="/login" method="post">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32"><a href="/register" class="fw-700 ml-1">Register as student/parent</a><a href="/recruiter/register" class="fw-700 ml-3">Register as recruiter</a></h6>
