...
<body class="color-theme-orange mont-font">
    ...
    <div class="main-wrapper">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-xxl-9">
                            <div class="card border-0 mb-0 rounded-lg overflow-hidden">
                                ...
                                <video id="video" class="video-js" controls preload="auto" width="900"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show {{ $data['id'] == 0 ? 'active' : '' }}" id="navtabs0">
                                    <div class="video-playlist shadow-xss"
                                        ...
                                        @endphp
                                        <p class="text-dark fw-300 font-xss">{{ count($video_count) }}&nbsp; Videos</p>
                                ...
                                <div class="tab-pane fade show {{ $data['id'] == 2 ? 'active' : '' }}" id="navtabs2">
                                    <div
                                        class="card w-100 d-block chat-body p-0 border-0 shadow-xss rounded-lg mb-3 position-relative">
                                        <div class="messages-content scroll-bar p-3" id="messagesContent"
                                            style="height: 390px;">
                        ...
                        <div class="col-xl-12 col-xxl-12">
                            <div
                                ...
                                <span
                                    class="font-xssss fw-700 text-grey-900 d-inline-block ml-0 text-dark">{{ $data['trainer']->name }}</span>
                                <span class="dot ml-2 mr-2 d-inline-block btn-round-xss bg-grey"></span>
                                <span
                                    class="font-xssss fw-600 text-grey-500 d-inline-block ml-1">{{ $data['course']->course_category }}</span>


                                <span class="dot ml-2 mr-2 d-inline-block btn-round-xss bg-grey"></span>
                                <span
                                    class="font-xssss fw-600 text-grey-500 d-inline-block ml-1">{{ $data['course']->course_subcategory }}</span>
                            </div>
                            ...
                            <div class="card d-block border-0 rounded-lg overflow-hidden p-4 shadow-xss mt-4"
                                ...
                                @if (!empty($test->id))
                                    ...
                                    @if ($courseTestResult && $courseTestResult->score_percentage >= 50)
                                        <a
                                            href="/view_certificate/{{ $data['course']->id }}/{{ $courseTestResult->score_percentage }}">
                                            <h2 class="fw-700 font-sm mt-1 pl-1">View certificate. <i
                                                    class="ti-arrow-right font-sm text-dark float-right"></i></h2>
                                        </a>
                                    @else
                                        <a href="/take_test/{{ $data['course']->id }}/{{ $test->id }}">
                                            <h2 class="fw-700 font-sm mt-1 pl-1">Take test to get certified. <i
                                                    class="ti-arrow-right font-sm text-dark float-right"></i></h2>
                                        </a>
                                    @endif
                                @else
                                    <a href="#">
                                        <h2 class="fw-700 font-sm mt-1 pl-1">Test coming soon!. <i
                                                class="ti-arrow-right font-sm text-dark float-right"></i></h2>
                                    </a>
                                @endif
                            </div>
                                    ...
                                    <div class="item">
                                        <div
                                            ...
                                            <div class="card-body d-block w-100 pl-4 pr-4 pb-4 text-center">
                                                ...
                                                <a href="/view_project/{{ $mini_project->id }}"
                                                    class="text-dark text-grey-900">
                                                    <span
                                    ...
                                    <div class="item">
                                        <div
                                            ...
                                            <div class="card-body d-block w-100 pl-4 pr-4 pb-4 text-center">
                                                ...
                                                <div class="clearfix"></div>
                                                {{-- $assesments_given->id is the video id - will get the assesmetns for that video --}}
        ...
        <div class="app-footer border-0 shadow-lg">
            <a href="/default_live_stream/{{ $data['course']->id }}/0" class="nav-content-bttn nav-center"><i
                    class="feather-home"></i></a>
            <a href="/aprex/video_player_mobile/{{ $data['course']->id }}" class="nav-content-bttn"><i
                    class="feather-package"></i></a>
            <a href="/aprex/chat/{{ $data['course']->id }}" class="nav-content-bttn" data-tab="chats"><i
                    class="feather-layout"></i></a>
            <a href="/aprex/notes/{{ $data['course']->id }}" class="nav-content-bttn"><i
                    class="feather-layers"></i></a>
    ...
    <script>
            ...
            for (let i = 0; i < section_videos.length; i++) {
                ...
                if (section_videos[i].section_id == section.id) {
                    ...
                    assesments.forEach(assesment => {
                        if (assesment.section_name == section.id && assesment.video == section_videos[i]
                            .id) {
                            flag = 1;
                        }
                    });
                    ...
                    labs.forEach(lab => {
                        // console.log(lab.id);
                        // console.log(section_videos[i].lab_link);
                        if (lab.video_id == section_videos[i].id) {
                            lab_flag = 1;
                            lab_id = lab.id;
                            // console.log(lab.id);
                        }
                    ...
                    video_names_html +=
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between" style="width: 100%;margin-left: 2rem;">
                                ${flag == 1 ? `
                                    <div style="border: 1px solid #b8afaf;padding: 0 8px;"><a class="font-xssss" href="/take_assesment/${course_id}/${section.id}/${section_videos[i].id}">Assesments</a></div>` : ''}
                                <div style="border: 1px solid #b8afaf;padding: 0 8px;"><a class="font-xssss" href="/ebook/${section_videos[i].id}" >EBook</a></div>
                                ${lab_flag==1 ? `
                                    <div style="border: 1px solid #b8afaf;padding: 0 8px;"><a class="font-xssss" href="/lab/${lab_id}" >Lab</a></div>` : ''}
                            </div>
                        </div>
                    </li>`;
                }
        ...
        videos.forEach(selected_video => {
            ...
            selected_video.onclick = () => {
                ...
                match_video = section_videos.find(video => video.id == selected_video.dataset.id);
