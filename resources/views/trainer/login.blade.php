...
<body class="color-theme-blue">
            ...
            <div class="container-fluid pl-lg--5 pr-lg--5">
                <div class="row">
                    <div class="col-lg-9 navbar pt-0 pb-0">
                        <h1 class="fredoka-font ls-3 fw-700 text-current font-xxl">Elomoas <span class="d-block font-xsssss ls-1 text-grey-500 open-font ">Online Learning Course</span></h1>
                    ...
                    <div class="col-lg-3 text-right d-none d-lg-block">
                        <a href="#" class="header-btn bg-dark fw-500 text-white font-xsss p-2 lh-32 w100 text-center d-inline-block rounded-xl" data-toggle="modal" data-target="#Modallogin">Login</a>
                        <a href="#" class="header-btn bg-current fw-500 text-white font-xsss p-2 lh-32 w100 text-center d-inline-block rounded-xl" data-toggle="modal" data-target="#Modalregister">Register</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow-none border-0 ml-auto mr-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form action="/trainer/login" method="post">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a href="/trainer/register" class="fw-700 ml-1">Register</a></h6>
                        </div>
                        </form>
                        ...
                        <!-- <div class="col-sm-12 p-0 text-left">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a href="register" class="fw-700 ml-1">Register</a></h6>
                        </div> -->
                        <div class="col-sm-12 p-0 text-center mt-2">
                            ...
                            <div class="form-group mb-1"><a href="#" class="form-control text-left style2-input text-white fw-600 bg-facebook border-0 p-0 mb-2"><img src="https://via.placeholder.com/50x50.png" alt="icon" class="ml-2 w40 mb-1 mr-5"> Sign in with Google</a></div>
                            <div class="form-group mb-1"><a href="#" class="form-control text-left style2-input text-white fw-600 bg-twiiter border-0 p-0 "><img src="https://via.placeholder.com/50x50.png" alt="icon" class="ml-2 w40 mb-1 mr-5"> Sign in with Facebook</a></div>
                        </div>
                    </div>
                </div> 
            </div>
                        ...
                        <div class="card-body rounded-0 text-left p-3">
                            ...
                            <form action="/trainer/login" method="post">
                                ...
                                <div class="col-sm-12 p-0 text-left">
                                    ...
                                    <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a href="register.html" class="fw-700 ml-1">Register</a></h6>
                                </div>
                            </form>
    ...
    <!-- Modal Register -->
    <div class="modal bottom fade" id="Modalregister" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="ti-close text-grey-500"></i></button>
                <div class="modal-body p-3 d-flex align-items-center bg-none">
                    <div class="card shadow-none rounded-0 w-100 p-2 pt-3 border-0">
                        <div class="card-body rounded-0 text-left p-3">
                            ...
                            <form action="/register" method="post">
                                ...
                                <div class="form-group icon-input mb-1">
                                    <input type="Password" name="cnf_password" class="style2-input pl-5 form-control text-grey-900 font-xss ls-3" placeholder="Confirm Password">
                                    <i class="font-sm ti-lock text-grey-500 pr-0"></i>
                                </div>
                                <div class="form-check text-left mb-3">
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                ...
                                <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have account <a href="login.html" class="fw-700 ml-1">Login</a></h6>
                            </div>
                            <div class="col-sm-12 p-0 text-center mt-3 ">
                                
                                <h6 class="mb-0 d-inline-block bg-white fw-600 font-xsss text-grey-500 mb-4">Or, Sign in with your social account </h6>
                                <div class="form-group mb-1"><a href="#" class="form-control text-left style2-input text-white fw-600 bg-facebook border-0 p-0 "><img src="https://via.placeholder.com/50x50.png" alt="icon" class="ml-2 w40 mb-1 mr-5"> Sign in with Google</a></div>
                                <div class="form-group mb-1"><a href="#" class="form-control text-left style2-input text-white fw-600 bg-twiiter border-0 p-0 "><img src="https://via.placeholder.com/50x50.png" alt="icon" class="ml-2 w40 mb-1 mr-5"> Sign in with Facebook</a></div>
                            </div>
                        </div>
                    </div>                    
