<?php session()->put('curnav','school_assesment'); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
                            ...
                            <div class="float-right">
                                <a href="/admin/create_school_assesments" class="p-2  d-inline-block text-white fw-700 lh-30 rounded-lg  text-center font-xsssss ls-3 bg-current">Create Assesments</a>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                              ...
                              <br>
                                <a href="/admin/view_school_assesments/{{$subject->id}}" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg  text-center font-xsssss ls-3 bg-current">VIEW ASSESMENTS</a>
