                                ...
                                <div class="card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="text-center">
                                            <a href="/admin/quiz_details/{{$quiz->id}}" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current">DETAILS</a>
