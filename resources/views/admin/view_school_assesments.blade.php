                                ...
                                <table class="table">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-dark">Chapter Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td scope="row">{{$assessment->subject->subject_name }}</td>
                                            <td scope="row">{{$assessment->chapter->chapter_name}}</td>
                                            <td scope="row">{{$assessment->video->video_name}}</td>
