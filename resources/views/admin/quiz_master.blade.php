                    ...
                    <div class="mb-3">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-lg">
                                ...
                                <h4 class="font-xs text-white fw-600 ml-4 mb-0 mt-2">Quiz Master</h4>

                            </div>
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                <form action="/admin/quiz_master" method="get" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-4">
                                        <div class="col-lg-6">
                                            {{-- <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width"> --}}
                                            <div class="form-group">
                                                <label class="mont-font fw-600 font-xsss">Select Subject to filter</label>
