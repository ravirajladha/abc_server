                    ...
                    <div class="mb-3">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg justify-content-between">
                                ...
                                <div class="float-right">
                                    <ol class="breadcrumb " style="padding: 0.25rem 1rem;">
                                        ...
                                        <li class="active fw-500 text-black">&nbsp; Create Internship</li>
                                    </ol>
                                </div>
                            </div>
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                <form action="/admin/create_internship" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row mb-6">
                                        <div class="col-lg-6">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <label class="mont-font fw-600 font-xsss">Internship Title</label><br>
                                                <input type="text" name="internship_title" class="form-control" placeholder="Enter title" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <label class="mont-font fw-600 font-xsss">Internship Image</label><br>
                                                <input type="file" name="internship_image" class="form-control" required>
                                            </div>
                                        </div>
                                        {{-- <div class="col-lg-6">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <label class="mont-font fw-600 font-xsss">Stipend</label><br>
                                                <input type="number" placeholder="1.00" step="0.01" name="stipend" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
