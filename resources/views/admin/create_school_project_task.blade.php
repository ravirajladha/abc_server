...
@php
    $mini_projects = $data['mini_projects'];
@endphp
                    ...
                    <div class="mb-3">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg justify-content-between">
                                ...
                                <h2 class="fw-400 font-lg d-block">Create <b> </b> Project Task</h2>
                            ...
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                <form action="/admin/create_school_project_task" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row mb-6">
                                        <div class="col-lg-6">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <label class="mont-font fw-600 font-xsss">Select Project</label><br>

                                                 <select name="project_id" id="" class="form-control">
                                                    <option readonly disabled selected value="">-Select-</option>
                                                    @foreach ($mini_projects as $mini_project)
                                                    <option value="{{$mini_project->id}}">{{$mini_project->project_name}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
