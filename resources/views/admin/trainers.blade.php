<?php session()->put('curnav','trainer'); ?>
                    ...
                    <div class="mb-3">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg justify-content-between">
                                ...
                                {{-- <h4 class="font-xs text-white fw-600 ml-4 mb-0 mt-2">Add Trainer</h4> --}}
                                <h2 class="fw-400 font-lg d-block">Add <b> Trainer</b> </h2>
                                <div class="float-right">
                                    <ol class="breadcrumb " style="padding: 0.25rem 1rem;">
                                        ...
                                        <li class="active fw-500 text-black">&nbsp; Trainers</li>
                                    </ol>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                <form action="/admin/add_trainer" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row mb-6">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label class="mont-font fw-600 font-xsss">Name</label><br>
                                                <input type="text" name="name" class="form-control" placeholder="Enter Trainer Name" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label class="mont-font fw-600 font-xsss">Email</label><br>
                                                <input type="text" name="email" class="form-control" placeholder="Enter Trainer Email" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label class="mont-font fw-600 font-xsss">Phone number</label><br>
                                                <input type="number" name="phone" class="form-control" placeholder="Enter Phone Number" required>
                                            </div>
                                        </div>

                                                <input type="hidden" name="password" class="form-control" value="abc123" required readonly>
                        ...
                        <div class="">
                            <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                                <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                    <h2 class="fw-400 font-lg d-block">All <b> Trainers</b> </h2><br>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col">id</th>
