<div class="middle-sidebar-header bg-white">
                ...
                <ul class="d-flex ml-auto right-menu-icon">
                        ...
                        <a href="#"><span class="dot-count bg-warning"></span><i class="feather-bell font-xl text-current"></i>
                            <div class="menu-dropdown">
                                ...
                                <div class="card bg-transparent-card w-100 border-0 pl-5 mb-3">
                                    ...
                                    <h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">Java<span class="text-grey-400 font-xsssss fw-600 float-right mt-1"> 3 min</span></h5>
                                    <h6 class="text-grey-500 fw-500 font-xssss lh-4">New java course is available</h6>
                                </div>
                                <div class="card bg-transparent-card w-100 border-0 pl-5 mb-3">
                                    <img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 position-absolute left-0 rounded-circle">
                                    <h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">Python <span class="text-grey-400 font-xsssss fw-600 float-right mt-1"> 2 min</span></h5>
                                    <h6 class="text-grey-500 fw-500 font-xssss lh-4">New java course is available</h6>
                                </div>

                                <div class="card bg-transparent-card w-100 border-0 pl-5 mb-3">
                                    <img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 position-absolute left-0 rounded-circle">
                                    <h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">Php<span class="text-grey-400 font-xsssss fw-600 float-right mt-1"> 1 min</span></h5>
                                    <h6 class="text-grey-500 fw-500 font-xssss lh-4">New java course is available</h6>
                                </div>
                                <div class="card bg-transparent-card w-100 border-0 pl-5">
                                    <img src="https://via.placeholder.com/50x50.png" alt="user" class="w40 position-absolute left-0 rounded-circle">
                                    <h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">Java Script <span class="text-grey-400 font-xsssss fw-600 float-right mt-1"> 30 sec</span></h5>
                                    <h6 class="text-grey-500 fw-500 font-xssss lh-4">New java course is available</h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <li><a href="/default_user_profile"><i class="feather-user text-grey-900 font-lg"></i></a></li>
