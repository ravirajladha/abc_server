                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card w-100 bg-lightblue p-lg-5 p-4 border-0 rounded-lg d-block float-left">
                                ...
                                <h2 class="display1-size display2-md-size d-inline-block float-left mb-0 text-grey-900 fw-700"><span class="font-xssss fw-600 text-grey-500 d-block mb-2 ml-1">Welcome back</span> Hi, Recruiter.</h2>
                                ...
                                <div class="card-body p-4">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <h2 class="text-grey-900 fw-700 display1-size mt-2 mb-2 ls-3 lh-1">210 </h2>
                                            <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0"> Applications</h4>                             
                                        </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0"> Job Postings</h4>                             
                                        </div>
                                        <div class="col-5 text-left">
                            ...
                            <div class="card w-100 p-1 border-0 mt-4 rounded-lg bg-white shadow-xs overflow-hidden">
                                <div class="card-body p-4">
                                    <div class="row">
                                        <div class="col-7">
                                            <h4 class="fw-700 text-success font-xssss mt-0 mb-0 "></h4>
                                            <h2 class="text-grey-900 fw-700 display1-size mt-2 mb-2 ls-3 lh-1">45 </h2>
                                            <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0"> Tests</h4>                             
                                        </div>
                                        <div class="col-5 text-left">
                            ...
                            <div class="card w-100 p-3 border-0 mt-4 rounded-lg bg-white shadow-xs overflow-hidden">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 mb-1 text-center">
                                        <h2 class="font-xl text-grey-900 fw-700 ls-lg">110</h2>
                                    ...
                                    <div class="col-6 mb-1 text-center">
                                        <h2 class="font-xl text-grey-900 fw-700 ls-lg">210</h2>
                            ...
                            <div class="card w-100 p-3 border-0 mt-4 rounded-lg bg-white shadow-xs overflow-hidden">
                                ...
                                <div class="row">
                                    <div class="col-4 text-center">
                                        ...
                                        <h4 class="text-grey-500 d-flex justify-content-center fw-600 ls-lg font-xsssss text-uppercase">Developer</h4>
                                    </div>
                                    <div class="col-4 text-center">
                                        <h2 class="font-lg text-grey-900 fw-700 ls-lg">55%</h2>
                                        <h4 class="text-grey-500 d-flex justify-content-center fw-600 ls-lg font-xsssss text-uppercase">Designer</h4>
                                    </div>
                                    <div class="col-4 text-center">
                                        <h2 class="font-lg text-grey-900 fw-700 ls-lg">67%</h2>
                                        <h4 class="text-grey-500 d-flex justify-content-center fw-600 ls-lg font-xsssss text-uppercase">Tester</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
