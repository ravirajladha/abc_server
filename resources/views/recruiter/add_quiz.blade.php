            ...
            <div class="middle-sidebar-bottom bg-lightblue theme-dark-bg row">
                        ...
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg">
                                ...
                                @foreach ($quiz_masters as $quiz_master)
                                    ...
                                    @endif
                                @endforeach
                                {{-- <h4 class="font-xs text-white fw-600 ml-4 mb-0 mt-2">Select Question({{$count}})</h4> --}}
                            ...
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                @foreach ($quiz_masters as $quiz_master)
                                    @if((in_array($quiz_master->id,$questions))==false)
                                        ...
                                        <a type="button" href="/recruiter/add_question_to_quiz/{{$quiz_master->id}}" id="" class="btn btn-default btn-add bg-current text-white font-xsss" style="float:right;">
                ...
                <div class="middle-sidebar-left col-lg-6">
                    ...
                    {{-- <div class=""> --}}
                            ...
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                @foreach ($questions as $question)
                                    ...
                                    @endphp
                                        @if ($quiz_master != null)
                                        <p class="text-dark">{{$i}}&nbsp;)&nbsp; {{$quiz_master->question}}</p>
                                        <a type="button" href="/recruiter/delete_question_from_quiz/{{$quiz_master->id}}" id="" class="btn btn-default btn-add bg-current text-white font-xsss" style="float:right;">
                        ...
                        <a href="/recruiter/all_quizzes" class="p-2 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current" style="float: right;">Save</a>
                    </div>
                </div>
            </div>
        </div>
