                    ...
                    <div class="">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg justify-content-between">
                                <h2 class="fw-400 font-lg d-block">Create <b> Ebook</b> </h2>
                                <div class="float-right">
                                    <ol class="breadcrumb " style="padding: 0.25rem 1rem;">
                                        ...
                                        <li><a class="fw-500 font-xsss text-dark" href="/admin/all_courses">&nbsp; Ebook</a>&nbsp;<i class="fa fa-angle-right"></i>
                                        </li>
                                        <li class="active fw-500 text-black">&nbsp; Create Ebook</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <form action="/admin/create_ebook" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            <label class="mont-font fw-600 font-xsss">Ebook Title</label>
                                            <input type="text" name="ebook_name" class="form-control" placeholder="Enter Course Title" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            <label class="mont-font fw-600 font-xsss">Ebook Image</label>
                                            <input type="file" name="ebook_image" class="form-control" required>
                                        </div>
                                    </div>
