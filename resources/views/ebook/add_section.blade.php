                    ...
                    <div class="">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 border-0 d-flex rounded-lg justify-content-between">
                                <h2 class="fw-400 font-lg d-block">Add <b> Sections</b> </h2>
                                <div class="float-right">
                                    <ol class="breadcrumb " style="padding: 0.25rem 1rem;">
                                        ...
                                        <li class="active fw-500 text-black">&nbsp; Add Sections</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <form action="/admin/add_section/{{$ebook_module->id}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    {{-- <div class="col-lg-4 mb-3">
                                        <label class="mont-font fw-600 font-xsss">Module Title</label>
                                        <textarea name="description" class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellcheck="false" readonly></textarea>
                                    </div> --}}
                                </div>
