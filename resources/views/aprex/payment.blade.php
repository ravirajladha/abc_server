                                        ...
                                        <div class="col-lg-12 mt-5">
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <a href="/aprex/createStudentSubscription" class="rounded-lg bg-current mb-2 mt-4 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-white d-block">Pay</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
