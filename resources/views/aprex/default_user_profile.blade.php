<?php session()->put('curnav','profile'); ?>
                ...
                <div class="middle-sidebar-left">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card w-100 bg-lightblue p-lg-5 p-4 border-0 rounded-lg d-block float-left">
                                    ...
                                    <h2 class="display1-size display2-md-size d-inline-block float-left mb-0 text-grey-900 fw-700"><span class="font-xssss fw-600 text-grey-500 d-block mb-2 ml-1">Welcome back</span>  {{session('rexkod_user_name')}} </h2>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0">LEARNING</h4>
                                            </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0"> PROGRESS</h4>
                                            </div>
                                            <div class="col-5 text-left">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <h4 class="fw-700 text-grey-500 font-xsssss ls-3 text-uppercase mb-0 mt-0">PERFORMANCE</h4>
                                            </div>
                                            <div class="col-5 text-left">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden p-4">
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <h4 class="fw-700 font-xsss mt-4">You have not filled profile details.</h4>
                                        @else
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                                <div class="card-image w-100 mb-3">
                                                    <a href="/aprex/default_course_details/{{$course_detail->id}}" class="video-bttn position-relative d-block"><img src="/{{$course_detail->course_image}}" alt="image" class="w-100"></a>
                                                </div>
                                                <div class="card-body pt-0">
                                                   
                                                   
                                                    <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="/aprex/default_course_details/{{$course_detail->id}}" class="text-dark text-grey-900">{{$course_detail->course_name}}</a></h4>
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        @if (count($data['all_jobs'])==0)
                                                <h4 class="fw-700 font-xsss mt-4">You have not applied any job.</h4>
                                        @else
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            <div id="accordion" class="accordion mb-0">
                                                ...
                                                <h4 class="fw-700 font-xsss mt-4">You have not given any quiz.</h4>
                                                @endif
                        ...
                        <div class="tab-pane fade" id="navtabs5">
                            <div class="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden p-4">
                                <div class="card-body mb-3 pb-0"><h2 class="fw-400 font-lg d-block">My<b> Internships</b> <a href="#" class="float-right"><i class="feather-edit text-grey-500 font-xs"></i></a></h2></div>
                                <div class="card-body pb-0">
                                    <div class="row">
                                        @if (count($data['all_internships'])==0)
                                        <h4 class="fw-700 font-xsss mt-4">You have not applied any internship.</h4>
                                        @endif
                        ...
                        <div class="tab-pane fade" id="navtabs6">
                            <div class="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden p-4">
                                <div class="card-body mb-3 pb-0"><h2 class="fw-400 font-lg d-block">My <b>Analytics</b> <a href="#" class="float-right"><i class="feather-edit text-grey-500 font-xs"></i></a></h2></div>
                                <div class="card-body pb-0">
                                    <div class="row">
                        ...
                        <div class="tab-pane fade" id="navtabs8">
                            <div class="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden p-4">
                                <div class="card-body mb-3 pb-0"><h2 class="fw-400 font-lg d-block">My<b> Certifications</b> <a href="#" class="float-right"><i class="feather-edit text-grey-500 font-xs"></i></a></h2></div>
                                <div class="card-body pb-0">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6 col-md-6">
                                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                                ...
                                                <h4 class="fw-700 font-xsss mt-4">Congratulations</h4>
                                                <p class="fw-500 font-xssss text-grey-500 mt-3">You have successfully completed the course.</p>
                                                <div class="clearfix"></div>
                                                <div class="progress mt-3 h10">
                                                  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
                                                </div>
                                                <a href="#" class="mt-3 d-inline-block text-grey-900 fw-700 rounded-lg text-center font-xssss ls-3">Connect to Linked In</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
