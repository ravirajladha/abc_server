                        ...
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="row">
                                <div class="col-lg-12 pt-2 mb-3 d-flex justify-content-between">
                                    <div>
                                        <h2 class="fw-400 font-lg d-block"><b> Forum</b> </h2>
                                    </div>
                                    <div class="float-right">
                                        <a href="/add_forum" class="btn btn-info float-right mt-2 mr-2 bg-current"
                            ...
                            <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                ...
                                <div class="my-auto">
                                    <div class="question">
                                        <h3>Question</h3>
                                        <p>{{ $forum_question->question }}</p>
                                        <a href="/answer_forum/{{ $forum_question->id }}"
                                    ...
                                    <div class="answers-container">
                                        @foreach ($forum_answers as $forum_answer)
                                            ...
                                            @endphp
                                            <div class="answer">
                                                <h4>Answer by {{ $student->name }}</h4>
                                                <p>{{ $forum_answer->answer }}</p>
                                            </div>
                                        @endforeach
                            ...
                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-2 border-0 text-left question-div">
                                <div class="row">
                                    <div class="col-lg-12 pt-2 mb-3 d-flex justify-content-between">
                                        ...
                                        <div class="float-right">
                                            <a href="/aprex/add_forum" class="btn btn-info float-right mt-2 mr-2 bg-current font-xssss fw-600"
                                                style="border: 0;"><i class="fa-solid fa-plus fa-xl"></i> ASK QUESTION</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body p-0" id="question">
                                    <div class="d-flex flex-column">
                                        ...
                                        <h3 class="font-sm text-grey-800 fw-700 lh-32 mt-4 mb-4">{{ $forum_question->question }}
                                            <a href="/aprex/answer_forum/{{ $forum_question->id }}"
