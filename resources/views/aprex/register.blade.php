            ...
            <div class="col-xl-7 vh-lg-100 align-items-center d-flex bg-white rounded-lg overflow-hidden">
                <div class="card shadow-none border-0 ml-auto mr-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form action="/aprex/register" method="post">
                            @csrf
                            ...
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-email text-grey-500 pr-0"></i>
                                <input type="number" name="phone" class="style2-input pl-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Phone Number" required>
                            </div>
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                ...
                                <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have account <a href="/aprex/login" class="fw-700 ml-1">Login</a></h6>
                            </div>
                        </form>
