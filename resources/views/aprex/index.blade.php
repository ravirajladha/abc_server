                                ...
                                <div class="item">
                                    <div class="card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 mb-4">
                                        <div class="card-image w-100 mb-3">
                                            <a href="/aprex/default_course_details/{{$courses->id}}" class="video-bttn position-relative d-block"><img src="/{{$courses->course_image}}" alt="image" class="w-100" style="height: 200px;"></a>
                                        </div>
                                        <div class="card-body pt-0">
                                            ...
                                            <h4 class="fw-700 font-xss mt-3 lh-28 mt-0"><a href="/aprex/default_course_details/{{$courses->id}}" class="text-dark text-grey-900">{{$courses->course_name}} </a></h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".result p", function() {
                ...
                var searchButtonUrl = "/aprex/default_course_details/" + resultId;
