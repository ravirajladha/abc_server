    ...
    <div class="main-wrapper">
          ...
          <div class="main-content menu-active">
            ...
            <div class="middle-sidebar-bottom">
                <div class="middle-sidebar-left bg-white dark-bg-transparent pr-0 mr-3">
                     <div class="row">
                        <div class="col-lg-6 col-xl-4 col-md-6 chat-left scroll-bar border-right-light pl-4 pr-4">
                            ...
                            <div class="section full mt-2 mb-2 pl-3">
                                <ul class="list-group list-group-flush">
                                    <li class="bg-transparent list-group-item no-icon pl-0"><figure class="avatar float-left mb-0 mr-3"><img src="https://via.placeholder.com/60x60.png" alt="image" class="w45"></figure><h3 class="fw-700 mb-0 mt-1"><a class="font-xsss text-dark text-grey-900 d-block" href="chat.html">Hurin Seary</a></h3> <span class="d-block">What's up, how are you?</span> <span class="badge mt-0 text-grey-500 badge-pill">4:09 pm</span><div class="snippet float-right" data-title=".dot-typing"><div class="stage"><div class="dot-typing"></div></div></div></li>
                                    <li class="bg-transparent list-group-item no-icon pl-0"><figure class="avatar float-left mb-0 mr-3"><img src="https://via.placeholder.com/60x60.png" alt="image" class="w45"></figure><h3 class="fw-700 mb-0 mt-1"><a class="font-xsss text-dark text-grey-900 d-block" href="chat.html">Victor Exrixon</a></h3> <span class="d-block">What's up, how are you?</span> <span class="badge badge-primary text-white badge-pill">2</span></li>
                                    <li class="bg-transparent list-group-item no-icon pl-0"><figure class="avatar float-left mb-0 mr-3"><img src="https://via.placeholder.com/60x60.png" alt="image" class="w45"></figure><h3 class="fw-700 mb-0 mt-1"><a class="font-xsss text-dark text-grey-900 d-block" href="chat.html">Surfiya Zakir</a></h3> <span class="d-block">What's up, how are you?</span> <span class="badge badge-danger text-white badge-pill">6</span></li>
                                    <li class="bg-transparent list-group-item no-icon pl-0"><figure class="avatar float-left mb-0 mr-3"><img src="https://via.placeholder.com/60x60.png" alt="image" class="w45"></figure><h3 class="fw-700 mb-0 mt-1"><a class="font-xsss text-dark text-grey-900 d-block" href="chat.html">Goria Coast</a></h3> <span class="d-block">What's up, how are you?</span> <span class="badge badge-primary text-white badge-pill">8</span></li>
                        ...
                        <div class="col-lg-6 col-xl-8 col-md-6 pl-0 d-none d-lg-block d-md-block">
                                ...
                                <div class="chat-body p-4">
                                    <div class="card dark-bg-transparent border-0 w-100 p-0 mb-3 shadow-none">
                                        <div class="card-body p-0">
                                            <h6 class="fw-600 text-grey-500 font-xssss">Today, 16th September 2020, 11:45 </h6>
                                            <h2 class="font-lg text-grey-900 fw-600">Meeting World</h2>
                                        </div>
                                    </div>
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default p-0 bg-transparent border-bottom rounded-0">
                                            <div class="panel-heading  pb-2" role="tab" id="headingOne">
                                                <a class="panel-title fw-400 mb-0 accordion-toggle icon-none d-flex justify-content-between pr-0 collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                                    <figure class="avatar mr-2 mb-0 w35 mt-1 pt-1"><img src="https://via.placeholder.com/60x60.png" alt="image" class="float-right shadow-sm rounded-circle w-100"></figure>
                                                    <span class="font-xsss text-grey-700 pt-2 mt-1 pl-2 fw-700 mb-0 mr-auto text-dark">Aenni Mirenda </span>
                                                    <span class="font-xssss text-grey-500 pt-2 mt-1 pl-2 fw-600 mb-0 ml-auto">14.09.2020 10:23</span>

                                                </a>
                                            </div>
                                            <div id="collapseOne" class="panel-collapse in collapse" role="tabpanel" aria-labelledby="headingOne" style="">
                                                <p class="text-grey-600 mb-4 mt-4 font-xsss fw-500">Hi Aenni, <br> <br> All individual Framer subscriptions have been grandfathered into a Pro plan at your existing rate. If you were on a Small Team plan, then all 5 seats have been converted over to Pro seats at your existing rate. <br><br> Regards,<br>Jessica </p>
                                            </div>
                                        </div>
                                        <div class="panel panel-default p-0 mb-0 bg-transparent border-bottom rounded-0">
                                            <div class="panel-heading pb-2" role="tab" id="headingTwo">
                                                <a class="panel-title fw-400 mb-0 accordion-toggle icon-none collapsed d-flex justify-content-between pr-0" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                    <figure class="avatar mr-2 mb-0 w35 mt-1 pt-1"><img src="https://via.placeholder.com/60x60.png" alt="image" class="float-left shadow-none rounded-circle w-75 mt-1"></figure>
                                                    <span class="font-xsss text-grey-700 pt-2 mt-1 pl-2 fw-700 mb-0 mr-auto text-dark">You</span>
                                                    <span class="font-xssss text-grey-500 pt-2 mt-1 pl-2 fw-600 mb-0 ml-auto">14.09.2020 11:45</span>

                                                </a>
                                            </div>
                                            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                                <div class="panel-body pt-4">
                                                    <p class="text-grey-600 mb-4 font-xsss fw-500">Hi Aenni, <br> <br> All individual Framer subscriptions have been grandfathered into a Pro plan at your existing rate. If you were on a Small Team plan, then all 5 seats have been converted over to Pro seats at your existing rate. <br><br> Regards,<br>Jessica </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default p-0 bg-transparent rounded-0">
                                            <div class="panel-heading pt-1 pb-2" role="tab" id="headingThree">
                                                <a class="panel-title fw-400 mb-0 accordion-toggle icon-none d-flex justify-content-between pr-0" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                                    <figure class="avatar mr-2 mb-0 w35 mt-1 pt-1"><img src="https://via.placeholder.com/60x60.png" alt="image" class="float-right shadow-sm rounded-circle w-100"></figure>
                                                    <span class="font-xsss text-grey-700 pt-2 mt-1 pl-2 fw-700 mb-0 mr-auto text-dark">Aenni Mirenda </span>
                                                    <span class="font-xssss text-grey-500 pt-2 mt-1 pl-2 fw-600 mb-0 ml-auto">14.09.2020 12:23</span>

                                                </a>
                                            </div>
                                            <div id="collapseThree" class="panel-collapse collapse in show" role="tabpanel" aria-labelledby="headingThree">
                                                <p class="text-grey-600 mb-4 font-xsss fw-500 mt-3">Hi Aenni, <br> <br> All individual Framer subscriptions have been grandfathered into a Pro plan at your existing rate. If you were on a Small Team plan, then all 5 seats have been converted over to Pro seats at your existing rate. <br><br> Regards,<br>Jessica </p>
                            ...
                            <div class="chat-bottom dark-bg p-3 border-top border-bottom" style="width: 98%;">
                                <form class="chat-form d-block">
                                    <button class="bg-dark border-0 btn-round-md float-left"><i class="ti-microphone text-white lh-4 font-md"></i></button>
                                    <button class="bg-dark border-0 btn-round-md ml-2 float-left"><i class="ti-clip text-white lh-4 font-md"></i></button>
                                    <button class="bg-dark border-0 btn-round-md ml-2 float-left"><i class="ti-image text-white lh-4 font-md"></i></button>
                                    <button class="bg-current border-0 p-0 float-right w200 text-white fw-600 font-xsss text-uppercase">Send</button>
                                </form>
                            </div> 
                        </div>
