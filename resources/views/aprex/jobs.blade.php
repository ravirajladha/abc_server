                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                ...
                                <form method="post" action="/aprex/apply_job">
                                    @csrf
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        @elseif ($jobQuiz)
                                            <a href="/aprex/take_quiz/{{ $jobQuiz->id }}" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w200 text-center font-xsssss ls-3 bg-current border-0">TAKE QUIZ</a>
                                        @elseif (!$jobQuiz)
                                        <button type="submit" class="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w200 text-center font-xsssss ls-3 bg-current border-0">APPLY</button>
                                        @endif
                                    </div>
